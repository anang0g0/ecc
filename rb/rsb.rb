...
@h=Array.new(5){Array.new(16) {0}}
@temp=Array.new(5){Array.new(16) {0}}
@tmp=Array.new(5){Array.new(16) {0}}
@ss=Array.new(5){Array.new(16) {0}}
lo=[32]
ev=[16]
N=16
K=4
...
for i in 0..2
  for j in 0..3
    ...
    @ss[1][j]=@temp[1][j];
    @ss[1][3]=0;
    @ss[2][j]=mlt(@fg[@temp[2][j]],div(1,@fg[3]));
  end
  print "\n"
end
  print "\n"
